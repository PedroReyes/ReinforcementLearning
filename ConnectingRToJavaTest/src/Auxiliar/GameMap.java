...
public class GameMap {
	...
	public void resetMap() {
		...
		map = new HashMap<Point, STATES>();

		// Dimensiones del mapa
		GameMap.dimX = GameMap.dimX == 0 ? 3 : GameMap.dimX;
		GameMap.dimY = GameMap.dimY == 0 ? 3 : GameMap.dimY;
	...
	public String[] getMapAsMatrix() {
		...
		for (Map.Entry<Point, STATES> entry : getMap().entrySet()) {
			...
			map[pos.x * getDimX() + pos.y] = entry.getValue().name();
		}
