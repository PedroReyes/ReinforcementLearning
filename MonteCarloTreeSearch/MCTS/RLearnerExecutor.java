...
public class RLearnerExecutor {
	...
	public RLearnerExecutor(int sizeMap, int numberOfEpisodes, double initialPolicyValues, double alpha, double gamma,
			double epsilonInicial, double epsilonFinal, double cExploratoryUCB, boolean usePersonalizedMap,
			String learningMethod, String actionSelectionMethod) {
		// ================================
		// GENERAL PARAMETERS
		// ================================
		this.sizeMap = sizeMap;
		this.numberOfEpisodes = numberOfEpisodes;
		GameMap.usePersonalizedMaps = usePersonalizedMap;
	...
	public static void main(String[] args) {
		...
		RLearnerExecutor rlExecutor = new RLearnerExecutor(sizeMap, numberOfEpisodes, initialPolicyValues, alpha, gamma,
				epsilonInicial, epsilonFinal, 0.01, true, LEARNING_METHOD.values()[0].name(),
				SELECTION_METHOD.values()[0].name());
