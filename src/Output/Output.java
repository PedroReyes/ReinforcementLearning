...
public class Output {
	...
	public static enum typeOfCharts {
		...
		winsInFirstTask // Description: display the number of victories just in the first episode
	};
	...
	public static String[] simulationPathExperimentosGameWorldWithMap = new String[] {
			originalPath + "/Experimentos/GameProblemWithMap/bests_6x6" // 0
			, originalPath + "/Experimentos/GameProblemWithMap/1_Qlearning_eGreedyMap_3x3" // 1
