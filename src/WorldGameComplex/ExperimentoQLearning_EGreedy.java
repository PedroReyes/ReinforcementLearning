...
public class ExperimentoQLearning_EGreedy {
	...
	public static void main(String[] args) {
		...
		if (true) { // (=0 then we have a 1-step TD backup, = 1 then we have a Monte Carlo backup)
			...
			//			discountFactorValues[1] = 0.8;
			//			discountFactorValues[2] = 0.4;
			//			discountFactorValues[3] = 0.6;
			//			discountFactorValues[4] = 0.8;
			//			discountFactorValues[5] = 1.0;
		}
